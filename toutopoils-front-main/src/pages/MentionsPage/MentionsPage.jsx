...
function MentionsPage() {
  ...
  return (
    <>
      <h1 className='title-page'>Conditions générales et mentions légales</h1>
      
      <ul className='justify-content'>
        <li>
            <h2>Article 1 : Objet</h2>
            <p>Les présentes « conditions générales d’utilisation » ont pour objet l’encadrement juridique des modalités de mise à disposition des services du site "ToutOPoils" et leur utilisation par l’utilisateur du site (ci après « l’Utilisateur »).  Aucun contrat sera produit entre le site et l’Utilisateur puisque libre de droits. L’accès au site par l’Utilisateur signifie son acceptation des présentes conditions générales d’utilisation.
            </p>
         </li>
        ...
        <li>
            <h2>Article 4 : Propriété intellectuelle. Droits d’auteur et copyright</h2>
            <p>
             Le site «ToutOPoils» relève de la législation française et internationale sur le droit d’auteur et fait l’objet d’une protection par le Code de la propriété intellectuelle. Tout le contenu du présent site est libre de droits.
             </p>
        </li>

        <li>
            <h2>Article 5 : Données collectées</h2>
             <p>
